...
//    public final static String FILE_UPLOAD_DIC = "/opt/image/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "E:\\其他\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int SHOPPING_CART_ITEM_LIMIT_NUMBER = 99;//购物车中单个商品的最大购买数量(可根据自身需求修改)
